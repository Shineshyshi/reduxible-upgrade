...
var Reduxible = function () {
  function Reduxible() {
    ...
    this.storeFactory = new _StoreFactory2["default"]((0, _extends3["default"])({}, options, {
  ...
  Reduxible.prototype.server = function server() {
    ...
    return function () {
      var _ref = (0, _asyncToGenerator3["default"])( /*#__PURE__*/_regenerator2["default"].mark(function _callee(req, res, next) {
        var history, store, router, url, _ref2, redirectLocation, rendered;
  ...
  Reduxible.prototype.preInitialize = function () {
    var _ref3 = (0, _asyncToGenerator3["default"])( /*#__PURE__*/_regenerator2["default"].mark(function _callee2(store) {
      var willDispatch;
  ...
  Reduxible.prototype.client = function client() {
    ...
    var history = void 0;
    try {
      history = this.config.useHashHistory() ? (0, _history.createHashHistory)() : (0, _history.createBrowserHistory)();
    } catch (error) {
